...
## Installation
  ...
  5. Run `ansible-playbook main.yml --check --ask-become-pass --ask-pass --ask-vault-pass` inside this directory. Enter your password when prompted for the passwords.
     Or run `setup.sh`.
